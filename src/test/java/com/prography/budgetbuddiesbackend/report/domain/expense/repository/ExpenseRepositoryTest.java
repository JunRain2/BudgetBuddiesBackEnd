...
class ExpenseRepositoryTest {
	...
	void 카테고리별_월별_합계_정상_및_경계_테스트() {
		...
		expenseRepository.save(Expense.of(userId, catA, 1000, "A지출", LocalDate.of(2024, 6, 10)));
		// 2024-07, catA: 2000
		expenseRepository.save(Expense.of(userId, catA, 2000, "A지출", LocalDate.of(2024, 7, 1)));
		// 2024-06, catA: soft delete
		Expense deleted = Expense.of(userId, catA, 9999, "삭제지출", LocalDate.of(2024, 6, 11));
